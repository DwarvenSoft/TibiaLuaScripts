...
local config = {
	...
	[22608]	= {
		...
		chance = 65,
		fail = {
			{run = true, text = 'The sea devil ran away.'},
			{sound = 'GRRRRRRRRRRR', text = 'The sea devil is growling at you.'}
		},
		success = {sound = 'Grrrrrrr', text = 'You tamed the sea devil.'}
	},
	[22608]	= {
		name = 'coralripper',
		id = 735,
		...
		chance = 65,
		fail = {
			{run = true, text = 'The coralripper ran away.'},
			{sound = 'GRRRRRRRRRRR', text = 'The coralripper is growling at you.'}
		},
		success = {sound = 'Grrrrrrr', text = 'You tamed the coralripper.'}
	},
	[22608]	= {
		name = 'plumfish',
		id = 736,
		...
		chance = 65,
		fail = {
			{run = true, text = 'The plumfish ran away.'},
			{sound = 'GRRRRRRRRRRR', text = 'The plumfish is growling at you.'}
		},
		success = {sound = 'Grrrrrrr', text = 'You tamed the plumfish.'}
	}
}
